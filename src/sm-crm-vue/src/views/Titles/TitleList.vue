<script setup>
    ...
    import TitleModal from '@/views/Titles/TitleModal.vue'
    import TitleViewModal from '@/views/Titles/TitleViewModal.vue'
    ...
    function editItem(id) {
        axios.get('/Titles/' + id).then(result => {
    ...
    function deleteItem(id) {
        swal_confirm().then(result => {
            if (result.value) {
                axios.delete("/Titles/" + id).then(res => {
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="col-12">
                ...
                <TitleModal :item="dataItem" @onSaved="itemSaved" />
                <TitleViewModal :item="dataItem" />
