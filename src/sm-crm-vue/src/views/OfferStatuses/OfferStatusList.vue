<script setup>
    ...
    import OfferStatusModal from '@/views/OfferStatuses/OfferStatusModal.vue'
    import OfferStatusViewModal from '@/views/OfferStatuses/OfferStatusViewModal.vue'
    ...
    function fetchItems(page = 1) {
        currentPage = page;
        axios.get('/OfferStatuses', { params: {
            pageNumber: page,
    ...
    function editItem(id) {
        axios.get('/OfferStatuses/' + id).then(result => {
    ...
    function deleteItem(id) {
        swal_confirm().then(result => {
            if (result.value) {
                axios.delete("/OfferStatuses/" + id).then(res => {
