...
import TerritoryModal from '@/views/Territories/TerritoryModal.vue'
import TerritoryViewModal from '@/views/Territories/TerritoryViewModal.vue'
...
function editItem(id) {
    axios.get('/Territories/' + id).then(result => {
...
function deleteItem(id) {
    swal_confirm().then(result => {
        if (result.value) {
            axios.delete("/Territories/" + id).then(res => {
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="col-12">
                ...
                <TerritoryModal :item="dataItem" @onSaved="itemSaved" />
                <TerritoryViewModal :item="dataItem" />
