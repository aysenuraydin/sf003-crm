...
import CustomerModal from '@/views/Notification/NotificationModal.vue'
import CustomerViewModal from '@/views/Notification/NotificationViewModal.vue'
...
function editItem(id) {
    axios.get('/Notification/' + id).then(result => {
